...
\begin{document}
	...
	\begin{enumerate}
		...
		\end{center}
		Liczba ramek rośnie eksponencjalne aż napotka limit w postaci \emph{slow start threshold}u. Nie przekracza go. Gdyby w piątej kolumnie nie wystąpił błąd, liczba ramek w kolejnych rosłaby liniowo. Wówczas, po napotkaniu błędu we wzroście liniowym, \emph{treshold} dla kolejnego \emph{timeout}u byłby mniejszy o połowę.
